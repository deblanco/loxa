...
Which is still the case it protects against: the strip's *tiles*. Each cut is
photographed on two models, and the strip picks which of the two it shows when
