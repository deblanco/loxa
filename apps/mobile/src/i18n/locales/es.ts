...
const es: typeof en = {
  ...
  consent: {
    ...
    renderGoesTo: 'Un modelo de imagen de Google, que la transforma. Si Google está ocupado, uno de nuestros socios ejecuta el mismo modelo (nombrado en nuestra política de privacidad).',
    ...
    analysisGoesTo: 'Un modelo de visión con IA que la lee, gestionado por uno de nuestros socios (nombrado en nuestra política de privacidad). Si no está disponible, otro socio usa otro.',
