...
const it: typeof en = {
  ...
  consent: {
    ...
    renderGoesTo: 'Un modello di immagini di Google, che la trasforma. Se Google è occupato, uno dei nostri partner esegue lo stesso modello (indicato nella nostra informativa sulla privacy).',
    ...
    analysisGoesTo: 'Un modello di visione IA che la legge, gestito da uno dei nostri partner (indicato nella nostra informativa sulla privacy). Se non è disponibile, un altro partner ne usa un altro.',
