...
const en = {
  ...
  consent: {
    ...
    renderGoesTo: 'An image model from Google, which restyles it. If Google is busy, one of our partners runs the same model instead (named in our privacy policy).',
    ...
    analysisGoesTo: 'An AI vision model that reads it, run by one of our partners (named in our privacy policy). If that is unavailable, another partner runs one.',
