...
namespace margelo::nitro::facetrack {
  ...
  /**
   * A struct which can be represented as a JavaScript object (FacePoint).
   */
  struct FacePoint final {
  public:
  ...
  public:
    FacePoint() = default;
    explicit FacePoint(double x, double y): x(x), y(y) {}

  public:
    friend bool operator==(const FacePoint& lhs, const FacePoint& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ FacePoint <> JS FacePoint (object)
  template <>
  struct JSIConverter<margelo::nitro::facetrack::FacePoint> final {
    static inline margelo::nitro::facetrack::FacePoint fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::facetrack::FacePoint(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::facetrack::FacePoint& arg) {
